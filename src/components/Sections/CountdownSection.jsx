		...
		<section className='bg-gray-100'>
			...
			>
				...
				<div style={{ position: 'relative', zIndex: 2 }} className='bg-indigo-50 p-4 rounded-lg text-center'>
					<h2 className='text-2xl font-bold text-indigo-600 mb-4'>{voucherDetail.Name}</h2>
					<h3 className='text-2xl font-bold text-indigo-600 mb-4'>
						Giảm giá {voucherDetail.PercentDiscount + '%'} tối đa {voucherDetail.MaximumMoneyDiscount}
					</h3>

					{/* Countdown Timer */}
					<h3 className='text-xl font-semibold text-gray-800 text-center mb-4'>Time Remaining</h3>
